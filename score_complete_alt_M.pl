...
$valid_command="perl score_complete_alt_M.pl -ifile <input> -leQTL <qfile> -similarD <sfile> -disease <disease_terms> -lgenes <lgenes> -nind <nind> -AF <af> -score_AF <val> -score_functional <val> -score_NS <val> -score_nIND <val> -scoreeQTL <val> -scoreG <val> -scoreT <val> -scoreM <val> -scoreR <val> -scoreSP <val> -scoreGW <val> -AD <AD> -XL <T/F>  -ofile <tabular output file> -ovcfile <vcf output file> -osummary <score computation summary file>";
...
unless ($arguments{"ifile"})
{

        die("The input file was not provided.This is a mandatory file.\n\nSee here: $valid_command\n\nFor an example of a valid command\n");
}
...
for ($i=0;$i<=$#ARGV;$i+=2)
{
	...
	if (exists $arguments{$act})
	{
		...
		warn("See here for a valid command:$valid_command\n\n");
